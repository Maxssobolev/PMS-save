...
export default function PatientIntroductions(props) {
    ...
    function ActionsGroup(props) {
        ...
        return <Actions
            id={id}
            local='inputFields/patientIntroductionsTab'
    ...
    const columns = [
        { title: 'Introduction', field: 'introduction', headerSort: false },
