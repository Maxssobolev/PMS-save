...
export default function DischargeOutcomes(props) {
    ...
    function ActionsGroup(props) {
        ...
        return <Actions
            id={id}
            local='inputFields/dischargeOutcomesTab'
    ...
    const columns = [
        { title: 'Discharge Outcome', field: 'dischargeOutcome' },
